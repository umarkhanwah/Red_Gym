  ...
  const handleSearch = async() =>{
    if(search){
      ...
      const searchedExercises = exercisesData.filter(
        ...
        || exercise.instructions[0].toLowerCase().includes(search)
        || exercise.instructions[1].toLowerCase().includes(search)
        || exercise.instructions[2].toLowerCase().includes(search)
      );
    ...
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px">
      ...
      <Box position="relative" mb="72px">
          ...
          width : { lg : '800px' , xs : '350px'} , backgroundColor: "#fff" , borderRadius: '40px'
           ...
           height : '56px' , position : 'abosolute'
